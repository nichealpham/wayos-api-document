...
app.use('/department', swaggerUi.serve, (req, res) => res.send(swaggerUi.generateHTML(documentDepartment, options)));
...
app.use('/report', swaggerUi.serve, (req, res) => res.send(swaggerUi.generateHTML(documentReport, options)));
